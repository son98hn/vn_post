...
public class RoleModel extends AbstractModel<RoleModel> {
	...
	private List<List> listRoleDetail = new ArrayList<>();
	...
	public List<List> getListRoleDetail() {
		return listRoleDetail;
	}

	public void setListRoleDetail(List<List> listRoleDetail) {
		this.listRoleDetail = listRoleDetail;
	}
